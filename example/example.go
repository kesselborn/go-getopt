...
func main() {
	optionDefinition := getopt.Options{
		...
		{"secondaryports|s|SECONDARY_PORTS", "secondary ports", getopt.Optional | getopt.NoLongOpt, []int{5000, 5001, 5002}},
		{"instances||INSTANCES", "instances", getopt.Required, 4},
		{"keys||KEYS", "keys", getopt.Required, []string{"foo", "bar", "baz"}},
		{"logfile||LOGFILE", "logfile", getopt.Optional, "/var/log/foo.log"},
		{"files", "files", getopt.IsArg | getopt.Optional, ""},
		{"pass through", "pass through arguments", getopt.IsPassThrough, ""},
	}
	...
	fmt.Printf("secondaryports: %#v\n", options["secondaryports"].IntArray)
